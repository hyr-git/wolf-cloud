package com.hyr.mapstruct.fixed.test;
...
import com.hyr.mapstruct.fixed.convert.UserFactoryMapping;
...
public class MapStructTest {
  ...
  public void tetDomain2DTO() {
    ...
    UserVo userVo = UserFactoryMapping.INSTANCE.sourceToTarget(user);
    log.info("User: {}", user);
  ...
  public void testDTO2Domain() {
    ...
    User user = UserFactoryMapping.INSTANCE.targetToSource(userVo);
    log.info("UserVo: {}", userVo);
